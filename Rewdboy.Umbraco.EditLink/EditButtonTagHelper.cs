...
public class EditButtonTagHelper : TagHelper
{
    ...
    public override void Process(TagHelperContext context, TagHelperOutput output)
    {
        ...
        // 1. Konfigurera själva <a>-taggen
        output.TagName = "a";
        output.TagMode = TagMode.StartTagAndEndTag; // Säkerställer att vi får <a></a>
        ...
        output.Attributes.SetAttribute("title", "Edit page");

        // 2. Lägg SVG-ikonen INUTI taggen
        ...
        // 3. Lägg CSS-länken EFTER <a>-taggen (utanför länken)
        output.PostElement.SetHtmlContent("<link rel=\"stylesheet\" href=\"/_content/Rewdboy.Umbraco.EditLink/css/editbutton.css\" />");
    }
}